...
- 20番ワイルドゾーン北のポケセンとクエーサー社にピンを設置しておかないこと
- 20番ワイルドゾーン北のポケセンで回復し、その場で動かずに待機していること


## 使用実績
A0(実数値88)のAZフラエッテの厳選に成功しました。  
<img src="https://github.com/user-attachments/assets/a6b756b0-026c-4c1a-8253-ce00b0aa7a1b"  width=40% height=40%/>

## 謝辞
Poke-Controllerや自動化コミュニティの発展に貢献いただいた全ての方に感謝申し上げます。
